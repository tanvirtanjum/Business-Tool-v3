			...
			<form autocomplete="off" method="post" action="">
				<table>
					...
					<tr align="right">
						...
						<td align="left">
							<input type="text" class="tf" name="uidTF" id="uidTF" placeholder="User ID." value="<?php echo "$uid" ?>"> 
						</td>
					</tr>
					...
					<tr align="right">
						...
						<td align="left">
							<input type="password" class="tf" name="passTF" id="passTF" placeholder="Password" value="<?php echo "$pass" ?>"> 
						</td>
					</tr>
