			...
			<form action="" method="post">
				...
				<table name="buttons" class="btnTB">
					<tr>
						...
						<td class="col2"></td>
						<!--<td> <input type="submit" class="btn" name="insertBTN" value="INSERT" onclick='PASS()' <?php if($srchvalid==true){echo "disabled";} ?>> </td> -->
						<td> <button name="insertBTN" class="btn" value="INSERT" <?php if ($DONE== true){ echo "onclick='PASS()'";}?> <?php if($srchvalid==true){echo "disabled";} ?>> INSERT </button> </td>
						<td class="col2"></td>
						<td> <input type="submit" class="btn" name="updateBTN" value="UPDATE" <?php if($srchvalid==false){echo "disabled";} ?>> </td>
						<td class="col2"></td>
						<td> <input type="submit" class="btn" name="deleteBTN" value="DELETE" <?php if($srchvalid==false){echo "disabled";} ?>> </td>
					</tr>
				</table>
			</form>
		</div>
