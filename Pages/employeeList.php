				...
				<div class="floatRightTop">
					<table name="search&logout">
						<tr>
							...
							<td style="width:15%;"> </td>
							<td> <a href="advancedEmployeeSearch.php?uid=<?php echo $uid;?>&sid=<?php echo $sid;?>" target="_blank"> <button type="button" class="advsrchbtn" name="printbtn">Advanced Search</button> </a></td> 
